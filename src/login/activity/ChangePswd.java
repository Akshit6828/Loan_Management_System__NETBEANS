...
import java.sql.*;
import javax.swing.*;
public class ChangePswd extends javax.swing.JDialog {

      Connection con=null;
    ResultSet rs=null;
    Statement smt=null;
    public ChangePswd(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        try{
    ...
    private void initComponents() {
        ...
        jLabel5.setBackground(new java.awt.Color(101, 220, 170));
        jLabel5.setFont(new java.awt.Font("Century Schoolbook", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(97, 97, 163));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      // int t=smt.executeUpdate("update password from customers where")//===========================
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChangePswd dialog = new ChangePswd(new javax.swing.JFrame(), true);
